...
export declare function optional<F extends AnyAssertFunc>(assert: F): import("../types").AssertDelegate<(F extends import("../types").Constructor<infer T> ? T : F extends ((name: string, mixed: unknown) => infer T) & {
    ...
    __accepts: (F extends import("../types").Constructor<infer T> ? T : F extends ((name: string, mixed: unknown) => any) & {
        __accepts: unknown;
    ...
    __canAccept: (F extends import("../types").Constructor<infer T> ? T : F extends ((name: string, mixed: unknown) => any) & {
        __canAccept: unknown;
